...
\aufgabe{}
Zeige, dass \(S^0 \ast A \simeq \Sigma A\).

\aufgabe{Die kleine Hopf-Faserung}
Konstruiere eine \(H\)-Raumstruktur auf \(S^0\) und folgere die Existenz einer Fasersequenz der Form
...
\aufgabe{}
Sei \(S\equiv(A \xleftarrow{f} C \xrightarrow{g} B)\) ein Span.
