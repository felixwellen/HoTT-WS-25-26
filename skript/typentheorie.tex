...
\begin{lemma}
  ...
  \begin{enumerate}[(a)]
  \item Sei $B(x)\colonequiv x=y_0$. Für alle $p:u=_Av$ und alle $q:u=y_0$ gilt $\transp_B(p)(q)=p^{-1}\kon q$.
  \item Sei $C(y)\colonequiv x_0=y$. Für alle $p:u=_Av$ und alle $q:x_0=v$ gilt $\transp_C(p)(q)=p^{-1}\kon q$.
  \end{enumerate}
\end{lemma}
\begin{beweis}
  Induktion über $p$.
